...
/***
 * Driver for a movie playing device that transmits information to DeviceDrivers
 * over a network
 * 
...
public class MoviePlayerDriver {
	...
	public static void main(String[] args) {
		...
		CountdownSimulator FightClub = new CountdownSimulator("Fight Club",
				139, 0, false, 10);
		CountdownSimulator PulpFiction = new CountdownSimulator("Pulp Fiction",
				154, 45, false, 7);
		CountdownSimulator ToyStoryThree = new CountdownSimulator(
				"Toy Story 3", 102, 0, false, 5);
