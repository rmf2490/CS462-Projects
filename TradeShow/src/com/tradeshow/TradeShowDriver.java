...
public class TradeShowDriver{
	...
	public static void main(String[] args) throws IOException {
		...
		//CountdownSimulator Avatar = new CountdownSimulator("James Cameron's Avatar", 162, 0, false, 10);
		CountdownSimulator ToyStoryThree = new CountdownSimulator("Toy Story 3", 102, 0, false, 30);
